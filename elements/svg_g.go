...
func (e *SVGGElement) REQUIRED_EXTENSIONSRemove() *SVGGElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGGElement) REQUIRED_FEATURESRemove() *SVGGElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGGElement) SYSTEM_LANGUAGERemove() *SVGGElement {
	if e.StringAttributes == nil {
		return e
	}
