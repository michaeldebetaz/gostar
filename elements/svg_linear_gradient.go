...
func (e *SVGLINEARGRADIENTElement) GRADIENT_UNITSRemove() *SVGLINEARGRADIENTElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGLINEARGRADIENTElement) GRADIENT_TRANSFORMRemove() *SVGLINEARGRADIENTElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGLINEARGRADIENTElement) SPREAD_METHODRemove() *SVGLINEARGRADIENTElement {
	if e.StringAttributes == nil {
		return e
	}
