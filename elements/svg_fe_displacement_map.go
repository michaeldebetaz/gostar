...
func (e *SVGFEDISPLACEMENTMAPElement) IN_2Remove() *SVGFEDISPLACEMENTMAPElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGFEDISPLACEMENTMAPElement) X_CHANNEL_SELECTORRemove() *SVGFEDISPLACEMENTMAPElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGFEDISPLACEMENTMAPElement) Y_CHANNEL_SELECTORRemove() *SVGFEDISPLACEMENTMAPElement {
	if e.StringAttributes == nil {
		return e
	}
