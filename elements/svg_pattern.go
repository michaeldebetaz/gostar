...
func (e *SVGPATTERNElement) PATTERN_UNITSRemove() *SVGPATTERNElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGPATTERNElement) PATTERN_CONTENT_UNITSRemove() *SVGPATTERNElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGPATTERNElement) PATTERN_TRANSFORMRemove() *SVGPATTERNElement {
	if e.StringAttributes == nil {
		return e
	}
