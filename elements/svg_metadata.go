...
func (e *SVGMETADATAElement) REQUIRED_EXTENSIONSRemove() *SVGMETADATAElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGMETADATAElement) REQUIRED_FEATURESRemove() *SVGMETADATAElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGMETADATAElement) SYSTEM_LANGUAGERemove() *SVGMETADATAElement {
	if e.StringAttributes == nil {
		return e
	}
