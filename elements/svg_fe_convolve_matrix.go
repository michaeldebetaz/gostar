...
func (e *SVGFECONVOLVEMATRIXElement) KERNEL_MATRIXRemove() *SVGFECONVOLVEMATRIXElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGFECONVOLVEMATRIXElement) EDGE_MODERemove() *SVGFECONVOLVEMATRIXElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGFECONVOLVEMATRIXElement) KERNEL_UNIT_LENGTHRemove() *SVGFECONVOLVEMATRIXElement {
	if e.StringAttributes == nil {
		return e
	}
...
// The preserveAlpha attribute indicates how the convolution will handle the
// alpha channel of the input image.
func (e *SVGFECONVOLVEMATRIXElement) PRESERVE_ALPHARemove() *SVGFECONVOLVEMATRIXElement {
	if e.BoolAttributes == nil {
		return e
	}
